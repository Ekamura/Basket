...
<div class="intro" id="intro">
    <div class="container">
        <div class="intro__inner">
            <h2 class="intro__suptitle">Спортивный инвентарь</h2>
        ...
        <div class="container">
            ...
            <div class="section__header">
                ...
                <div class="section__text">
                    <p>В данном разделе мы подробно расскажем вам о том как не ошибиться при выборе инвентаря</p>
                </div>
            </div>

            <div class="wedo">
                <div class="wedo__item">
                    <img class="wedo__img" src="/assets/images/close-up-of-basketball-player-with-ball-under-his-arm_23-2147604924.jpg" alt="">
                </div>
