...
<h2>Вы действительно хотите войти ?</h2>

<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Войти</button>

<div id="id01" class="modal">

    <form class="modal-content animate" action="/admin/auth/login.php" method="post" >
        ...
        <div class="container" style="background-color:#f1f1f1">
            <a href="/index.php" type="button" onclick="document.getElementById('id01').style.display='none'" class="cancelbtn">Выйти</a>
        </div>
    </form>
</div>
