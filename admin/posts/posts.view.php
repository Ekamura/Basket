    ...
    <div class="row" style="padding-left: 250px">
        ...
        <div>
            <?php foreach ($posts as $post): ?>
                <?php $images = $dataPost->getImagesForPost($post->id); ?>
                <div class="card">
                    <?php if ($images): ?>
                        <a href="/admin/posts/show.php?id=<?= $post->id ?>">
                            <img src="/img/<?= $images[0]->photo ?>" alt="" style="width: 200px; height: 190px">
                        </a>
                    <?php endif; ?>
                    <div class="text">
                        <h3><?= $post->name ?></h3>
                        <p><?= ShowData::showText($post->description) ?></p>
                        <?= ShowData::showDate($post->date) ?><br>
                        <a href="/admin/posts/show.php?id=<?= $post->id ?>" class="btn">Подробнее</a>
                    </div>
                </div>
            <?php endforeach; ?>
