    ...
    <div class="row" style="padding-left: 250px">
        <div class="container">
            <?php if ($post): ?>
                ...
                <div>
                    <?php foreach ($imagesForPost as $image):?>
                        <img src="/img/<?=$image->photo?>" alt="<?=$image->photo?>" style="width: 250px; height: 250px;">
                    <?php endforeach; ?>
                </div>
                <small><?= ShowData::showDate($post->date) ?></small>
            ...
            <form action="deletePost.php" method="post">
                ...
                <button type="submit" name="delete" id="delete" onclick="return confirm('Вы действительно хотите удалить статью?');">
                    Удалить запись
                </button><br><br>
            </form>
            <a class="btn" href="/admin/posts/edit.php?id=<?= $post->id ?>">Изменить статью</a>
