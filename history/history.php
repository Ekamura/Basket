    ...
    <div class="intro" id="intro">
        <div class="container">
            <div class="intro__inner">
                <h2 class="intro__suptitle">История</h2>
<!--                <h1 class="intro__title">Здесь вы подробно сможете ознакомиться с историей спорта и не только</h1>-->
        ...
        <div class="container">
            ...
            <div class="section__header">
                ...
                <div class="section__text">
                    <p>В данном разделе мы подробно расскажем вам о всех ключевых событиях в мире баскетбола</p>
                    <p>От истории зарождения спорта, до нашего времени </p>
                </div>
            </div>

            <div class="wedo">
                <div class="wedo__item">
                    <img class="wedo__img" src="/assets/images/istoria-basketbola.jpg" alt="">
                </div>
                ...
                <div class="wedo__item">
                    <div class="accordion">
                        ...
                        <div class="accordion__item" data-collapse="#wedo_3">
                            ...
                            <div class="accordion__content" id="wedo_3"> <p><?=$post4->description?></p>
                            </div>
                        </div>
                        <div class="accordion__item" data-collapse="#wedo_3">
                            <div class="accordion__header">
                            ...
                            <div class="accordion__content" id="wedo_3"> <p><?=$post5->description?></p>
                            </div>
                        </div>
                        <div class="accordion__item" data-collapse="#wedo_3">
                            <div class="accordion__header">
                            ...
                            <div class="accordion__content" id="wedo_3"> <p><?=$post6->description?></p>
                            </div>
                        </div>
                    </div><!-- /.accordion -->
